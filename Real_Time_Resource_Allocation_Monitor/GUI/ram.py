...
class ram_tab(QWidget, Ui_ram_tab):
    def __init__(self, parent=None):
        ...
        self.data_line = self.ram_plot.plot(range(60), list(repeat(0, 60)), 60, pen=(255, 255, 255), fillLevel=0,
                                            brush=(254,221,0, 100))
        ...
        self.bars = list()
        for x in range(4):
            self.bars.append(BarGraphItem(x0=[0], height=[0], width=0, pen=(255, 255, 255),
                                          brush=(255 - 4*x, 150 + 10 * x, 0, 100)))
